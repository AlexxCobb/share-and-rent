...
class ItemRequestControllerTest {
    ...
    void createRequest_whenDescriptionIsBlank_thenException() throws Exception {
        ...
        mvc.perform(post("/requests")
                ...
                .andExpect(jsonPath("$.error").value(containsString("Validation failed for argument [0] in public ru.practicum.shareit.request.dto.ItemRequestDto ru.practicum.shareit.request.controller.ItemRequestController")));
